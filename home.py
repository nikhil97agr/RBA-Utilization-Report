...
"border-radius : 5px")
    ...
    def generateReport(self):
        ...
        finalFileName=extract_filename.extract_filename(self.logFile)
        finalFileName=finalFileName+"_utilization_report_"
        finalFileName=extract_data.extract_data(name_list,self.logFile,finalFileName)
